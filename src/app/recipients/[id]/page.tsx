            ...
            <div className="py-6">
                ...
                <div className="space-y-6">
                    ...
                    <div>
                        ...
                        <Input id="your-reference" defaultValue="GSS MARKETING TRUST" className="bg-white" />
                    </div>

                    <div>
                        <Label htmlFor="recipient-reference" className="text-gray-500 text-xs">Recipient's reference</Label>
                        <Input id="recipient-reference" defaultValue="GSS MARKETING TRUST" className="bg-white" />
                    </div>
                </div>
            </div>
        )}
