...
function ShareProofOfPaymentContent() {
  ...
  const handleShare = async () => {
    ...
    try {
        ...
        page.drawLine({ start: { x: margin, y: lineY }, end: { x: width - margin, y: lineY }, thickness: 2, color: rgb(0.6, 0.6, 0.6) });
        let y = lineY - 25;
