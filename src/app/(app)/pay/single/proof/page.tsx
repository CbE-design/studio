...
const DetailRow = ({ label, value }: { label: string; value: string | null | undefined }) => (
    <tr className="align-top">
        ...
        <td className="py-1 font-semibold text-gray-800">{value || ''}</td>
    </tr>
);
...
function ProofOfPaymentContent() {
    ...
    const paymentDetails = {
        ...
        referenceNumber: `${format(now, 'yyyy-MM-dd')}/Nedbank/${Math.random().toString(36).substring(2, 12).toUpperCase()}`,
      ...
      <div className="flex flex-col h-screen bg-gray-100 text-sm">
        ...
        <main className="flex-1 overflow-y-auto p-4">
            <div id="proof-of-payment" className="bg-white p-6 max-w-2xl mx-auto shadow-md">
                ...
                <h2 className="text-lg font-bold mb-2">Notification of Payment</h2>
                <hr className="mb-4"/>
                ...
                <h3 className="font-bold mb-2">Payer details</h3>
                 <table className="w-full mb-6">
                     <tbody>
                ...
                <h4 className="font-bold text-xs mb-2">Nedbank Limited email disclaimer</h4>
