...
function SinglePaymentForm() {
  ...
  return (
    <div className="flex flex-col h-screen bg-gray-50">
      <header className="gradient-background text-primary-foreground p-4 flex items-start h-28 sticky top-0 z-10">
        ...
        <div className="p-4 space-y-6">
            ...
            <div className="space-y-4 py-4">
                ...
                <div className="flex justify-center">
                    <div className="bg-primary text-primary-foreground p-4 rounded-lg flex flex-col items-center justify-center w-48 h-36 cursor-pointer shadow-md">
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-12 w-12 text-white" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round">
                          <path d="M4 22h16"/>
                        ...
                        <span className="text-lg text-center mt-2">Pay to a bank account</span>
                    </div>
                </div>
            </div>
